...
for (i in 1:nrow(files)) {
  ...
  readgroup_name = files$sample[i] # Replace, if necessary, can be sample library name or can be retrieved from the header of the bam file
  sample_name = files$sample[i]
  library_name = paste0("Illumina-",readgroup_name)
  platform_unit = "HCLNVDSX7"
  run_date = "2023-09-11"
  platform = "Illumina"
